...
```{r}
grand_function(feature_dataframe = egemaps_dk, other_dataframe = egemaps_us, demo_dataframe = demodata, lang = "dk", task = "triangles", featureset = "egemaps")

nrow(read.csv("egemaps.dk.not_.triangles.csv"))
nrow(filter(egemaps_dk, condition != "triangles"))
